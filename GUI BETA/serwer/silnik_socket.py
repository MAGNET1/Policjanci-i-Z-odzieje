...
def tPlayerLoop(c, info, team, lock):
  while True:
    # first, we wait for the main thread to finish all the moves. After it's done, 'ct(tt)Thread' will be reset
